  ...
  <div class="payment-modal" id="payment-modal">
    ...
    <div class="payment-body" id="payment-body">
      ...
      <div class="payment-success" id="payment-success" style="display:none;">
        <canvas id="payment-success-rive" width="80" height="80" style="width:80px;height:80px;margin:0 auto 16px;display:block;"></canvas>
        <h3 style="text-align:center;">¡Pago Confirmado!</h3>
