    ...
    <div class="hero-slides" id="hero-slides">
      ...
      <div class="hero-slide" data-index="1">
        <div class="hero-content">
          ...
          <p class="hero-subtitle">Hasta 50% de descuento en productos seleccionados</p>
      ...
      <div class="hero-slide" data-index="2">
        <div class="hero-content">
          <h1 class="hero-title">Envío Gratis</h1>
          <p class="hero-subtitle">En compras mayores a $50.000, entregamos sin costo</p>
          <a href="#" class="btn-primary">Más Info</a>
        </div>
