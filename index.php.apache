  ...
  <section class="hero" id="inicio">
    <div class="hero-slides" id="hero-slides">
      <div class="hero-slide active" data-index="0">
        ...
        <canvas id="hero-rive-0" class="hero-rive-canvas" width="600" height="400"></canvas>
      </div>
      <div class="hero-slide" data-index="1">
        ...
        <canvas id="hero-rive-1" class="hero-rive-canvas" width="600" height="400"></canvas>
      </div>
      <div class="hero-slide" data-index="2">
        ...
        <canvas id="hero-rive-2" class="hero-rive-canvas" width="600" height="400"></canvas>
      </div>
    </div>
  ...
  <section class="ofertas" id="ofertas">
    ...
    <div class="ofertas-grid">
      <div class="oferta-card">
        <canvas id="ofertas-rive-1" width="120" height="120" style="width:120px;height:120px;"></canvas>
        <h3>30% OFF en Electrónica</h3>
        <p>Auriculares, relojes y tablets con descuento</p>
        <button class="btn-primary" onclick="showSection('productos')">Ver Ofertas</button>
      </div>
      <div class="oferta-card">
        <canvas id="ofertas-rive-2" width="120" height="120" style="width:120px;height:120px;"></canvas>
        <h3>2x1 en Moda</h3>
        <p>Zapatillas, bolsos y billeteras</p>
        <button class="btn-primary" onclick="showSection('productos')">Ver Ofertas</button>
      </div>
      <div class="oferta-card">
        <canvas id="ofertas-rive-3" width="120" height="120" style="width:120px;height:120px;"></canvas>
        <h3>Envío Gratis</h3>
        <p>En compras mayores a $50.000</p>
        <button class="btn-primary" onclick="showSection('productos')">Comprar Ahora</button>
      </div>
    </div>
  </section>
